...
// Fetch books for the 'History' category
$sql = "SELECT title, image_path, stock FROM product WHERE category = 'History'";
...
<div class="dashboard_container">
    <h1 class="cata-name">Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?>!</h1>
</div>

<h1 class="book-container-title">History Books</h1>
