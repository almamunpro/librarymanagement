...
// Fetch books for the 'Religion' category
$sql = "SELECT title, image_path, stock FROM product WHERE category = 'Religion'";
...
<h1 class="book-container-title">Religion Books</h1>
